  ...
  return (
    <>
      ...
      <Stack w="100vw" h="100vh" align="center" justify="center" m="0 auto" maxWidth="1120" spacing={12} p="4" my="6">
        ...
        <Text textAlign="center" fontSize={{base: "md", sm: "xl"}}>Se você é contador ou empresário, não fique de fora, confira o que mudou na nossa Nota Fiscal (A Moreninha), ficou ainda mais rápido e fácil fazer a emissão das suas notas fiscais,
